...
<body>
    ...
    10.3.2 Proportion of employees with disabilities
    </div>
    <div class="sidebar">
    ...
    <div class="container">
        <a href="10.3.2.php" class="back-button">Back</a>
    </div>
    ...
    if (isset($_POST['create'])) {
        ...
        $query = "INSERT INTO `10.3.2 proportion of employees with disabilities` 
    (total_number_of_employees_with_disabilities, 
    total_number_of_employees_with_disabilities_male, 
    total_number_of_employees_with_disabilities_female, 
    ...
    employees_population_belongs_to_PWDs, 
    total_number_of_PWDs_employees_that_have_PWD_ID,
    PWD_employee_population_have_a_PWD_ID ) 
    VALUES (
    '$total_numbers', 
    '$male_employees', 
    '$female_employees', 
    ...
    $query_fetch = "SELECT * FROM `10.3.2 proportion of employees with disabilities` ORDER BY id DESC LIMIT 1";
    ...
    <div class="form-container">
        <form action="" method="POST">
            <div class="form-group">
                <label for="total_numbers">Total number of employees with disabilities:
                    <input type="number" name="total_numbers" id="total_numbers" value="<?php echo isset($current_data['total_number_of_employees_with_disabilities']) ? $current_data['total_number_of_employees_with_disabilities'] : ''; ?>">
                    (Male: <input type="number" name="male_employees" id="male_employees" value="<?php echo isset($current_data['total_number_of_employees_with_disabilities_male']) ? $current_data['total_number_of_employees_with_disabilities_male'] : ''; ?>"> / Female: <input type="number" name="female_employees" id="female_employees" value="<?php echo isset($current_data['total_number_of_employees_with_disabilities_female']) ? $current_data['total_number_of_employees_with_disabilities_female'] : ''; ?>">
                </label>
            </div>
            ...
            <ul>
                <li>
                    <div class="form-group">
                        <label for="psychiatric_disorder">Psychiatric disorder (ex. anxiety, depression):
                            <input type="number" name="psychiatric_disorder" id="psychiatric_disorder" value="<?php echo isset($current_data['psychiatric_disorder']) ? $current_data['psychiatric_disorder'] : ''; ?>">
                        </label>
                    </div>
                </li>
            ...
            <div class="form-group">
                <input type="number" name="pwd_prevalence" id="pwd_prevalence" value="<?php echo isset($current_data['employees_population_belongs_to_PWDs']) ? $current_data['employees_population_belongs_to_PWDs'] : ''; ?>"> % of the employees population belongs to PWDs:
            </div>
            <div class="form-group">
                Total number of PWDs employees that have PWD ID: <input type="number" name="pwd_id_ownership" id="pwd_id_ownership" value="<?php echo isset($current_data['total_number_of_PWDs_employees_that_have_PWD_ID']) ? $current_data['total_number_of_PWDs_employees_that_have_PWD_ID'] : ''; ?>">
            </div>
            <div class="form-group">
                <input type="number" name="pwd_id_prevalence" id="pwd_id_prevalence" value="<?php echo isset($current_data['PWD_employee_population_have_a_PWD_ID']) ? $current_data['PWD_employee_population_have_a_PWD_ID'] : ''; ?>"> % of the PWD employee population have a PWD ID:
            </div>
            <div class="form-group">
