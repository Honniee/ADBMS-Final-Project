...
<body>
    ...
    <div class="container">
    <a href="10.3.2_update.php" class="update-button">Update Records</a>
    </div>
...
<div class="form-container">
    <div class="form-group">
        <label>Total number of employees with disabilities:
            <span style="text-decoration: underline; font-weight: bold;">
                <?php echo isset($current_data['total_number_of_employees_with_disabilities']) ? $current_data['total_number_of_employees_with_disabilities'] : 'N/A'; ?>
            </span>
            (Male:
            <span style="text-decoration: underline; font-weight: bold;">
                <?php echo isset($current_data['total_number_of_employees_with_disabilities_male']) ? $current_data['total_number_of_employees_with_disabilities_male'] : 'N/A'; ?>
            </span>
            / Female:
            <span style="text-decoration: underline; font-weight: bold;">
                <?php echo isset($current_data['total_number_of_employees_with_disabilities_female']) ? $current_data['total_number_of_employees_with_disabilities_female'] : 'N/A'; ?>
            </span>
            )
        </label>
    </div>
    ...
    <ul>
        <li>
            <div class="form-group">
                <label>Psychiatric disorder (ex. anxiety, depression):
                    <span style="text-decoration: underline; font-weight: bold;">
                        <?php echo isset($current_data['psychiatric_disorder']) ? $current_data['psychiatric_disorder'] : 'N/A'; ?>
                    </span>
                </label>
            </div>
        </li>
    ...
    <div class="form-group">
        <label>
            <span style="text-decoration: underline; font-weight: bold;">
                <?php echo isset($current_data['employees_population_belongs_to_PWDs']) ? $current_data['employees_population_belongs_to_PWDs'] : 'N/A'; ?>
            </span>% of the employees population belongs to PWDs
        </label>
    </div>
    <div class="form-group">
        <label>Total number of PWDs employees that have PWD ID:
            <span style="text-decoration: underline; font-weight: bold;">
                <?php echo isset($current_data['total_number_of_PWDs_employees_that_have_PWD_ID']) ? $current_data['total_number_of_PWDs_employees_that_have_PWD_ID'] : 'N/A'; ?>
            </span>
        </label>
    </div>
    <div class="form-group">
        <label>
            <span style="text-decoration: underline; font-weight: bold;">
                <?php echo isset($current_data['PWD_employee_population_have_a_PWD_ID']) ? $current_data['PWD_employee_population_have_a_PWD_ID'] : 'N/A'; ?>
            </span> % of the PWD employee population have a PWD ID
        </label>
    </div>
</div>
