...
<body>
  ...
  <div class="sidebar">
    ...
    <div class="Indicators">
      ...
      <div class="indicator1"><a href="../10.3.1/10.3.1.php">10.3.1 Proportion of students and employees with disabilities</a></div>
    ...
    if (isset($_GET['delete'])) {
        ...
        // SQL query
        $query = "DELETE FROM `10.1.1 research on reduced inequalities` WHERE id = {$id}";
        $delete_query = mysqli_query($connect, $query);
        header("Location: 10.1_read.php");
