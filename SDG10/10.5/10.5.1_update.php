...
<body>
  ...
  10.5.1 Proportion of students who are member of LGBTQIA+ group  </div>
  <div class="sidebar">
  ...
  <div class="container">
  <a href="10.5.1.php" class="back-button">Back</a>
</div>
...
<div class="form-container">
    ...
    <form action="" method="POST">
        ...
        Total number of students who are member of LGBTQIA+:<input type="number" name="total_numbers" id="total_numbers" value="<?php echo isset($current_data['total_number_of_students_who_are_member_of_LGBTQIA+']) ? $current_data['total_number_of_students_who_are_member_of_LGBTQIA+'] : ''; ?>">
        </div>

        <div class="form-group">
            <input type="number" name="LGBTQIA_prevalence" id="LGBTQIA_prevalence" value="<?php echo isset($current_data['student_population_are_members_of_LGBTQIA+_group']) ? $current_data['student_population_are_members_of_LGBTQIA+_group'] : ''; ?>"> % of student population are members of LGBTQIA+ group.
        </div>
