...
<body>
  <div class="header-SDG10">
    10.5.2 Proportion of employees who are member of LGBTQIA+ group
  </div>
  <div class="sidebar">
  ...
  <div class="container">
  <a href="10.5.2.php" class="back-button">Back</a>
</div>
...
if (isset($_POST['create'])) {
    ...
    $LGBTQIA_prevalence = $_POST['LGBTQIA_prevalence'];
     
 

    // SQL query to insert data into table
    $query = "INSERT INTO `10.5.2 proportion of employees who are member of LGBTQIA+ group`
      (`total_number_of_employees_who_are_member_of_LGBTQIA+`, 
        `employee_population_are_members_of_LGBTQIA+_group` ) 
        VALUES (
        '$total_numbers', 
        '$LGBTQIA_prevalence')";
...
$query_fetch = "SELECT * FROM `10.5.2 proportion of employees who are member of LGBTQIA+ group` ORDER BY id DESC LIMIT 1";
...
<div class="form-container">
    ...
    <form action="" method="POST">
        ...
        Total number of employees who are member of LGBTQIA+:<input type="number" name="total_numbers" id="total_numbers" value="<?php echo isset($current_data['total_number_of_employees_who_are_member_of_LGBTQIA+']) ? $current_data['total_number_of_employees_who_are_member_of_LGBTQIA+'] : ''; ?>">
        </div>

        <div class="form-group">
            <input type="number" name="LGBTQIA_prevalence" id="LGBTQIA_prevalence" value="<?php echo isset($current_data['employee_population_are_members_of_LGBTQIA+_group']) ? $current_data['employee_population_are_members_of_LGBTQIA+_group'] : ''; ?>"> % of employee population are members of LGBTQIA+ group.
        </div>
