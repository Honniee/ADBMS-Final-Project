...
<body>
    ...
    <div class="container">
    <a href="10.5.2_update.php" class="update-button">Update Records</a>
    </div>
...
<div class="form-group">
        <label>Total number of employees who are member of LGBTQIA+:
            <span style="text-decoration: underline; font-weight: bold;">
                <?php echo isset($current_data[`total_number_of_employees_who_are_member_of_LGBTQIA+`]) ? $current_data[`total_number_of_employees_who_are_member_of_LGBTQIA+`] : 'N/A'; ?>
            </span>
        </label>
    </div>
    ...
    <div class="form-group">
        <label>
            <span style="text-decoration: underline; font-weight: bold;">
                <?php echo isset($current_data['employee_population_are_members_of_LGBTQIA+_group']) ? $current_data['employee_population_are_members_of_LGBTQIA+_group'] : 'N/A'; ?>
            </span>% of employee population are members of LGBTQIA+ group.
        </label>
    </div>
