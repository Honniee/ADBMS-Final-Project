...
<body>
  ...
  <table class = "table1">
    <thead>
      ...
      <tr>
        <th>ID</th>
        <th>Total number of facilities available in the campus for PWDs</th>
        <th scope = "col" colspan = "2">EDIT DELETE OPERATIONS</th>
      </tr>
      <tr>
      <?php
        $query = "SELECT * FROM `10.8.7 accessible facilities`;";
        ...
        while($row = mysqli_fetch_assoc($view_users)){
          ...
          echo "<td> {$total_number_of_facilities_available_in_the_campus_for_pwds	}</td>";

          echo "<td> <a href = '10.8.7update.php?user_id={$id}' class = 'button2'> EDIT </a></td>";
          echo "<td> <a href = '10.8.7delete.php?delete={$id}' class = 'button3'> DELETE </a></td>";
        }
      ?>
      </tr>
  </table>
  <div>
    <button class = "back-button" onclick = "window.location.href= '10.8.7.php';">&laquo; Back</button>
  </div>
