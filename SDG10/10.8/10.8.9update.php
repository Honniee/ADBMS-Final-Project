...
<body>
  ...
  <?php
      ...
      $query = "SELECT * FROM `10.8.9 disability access scheme` WHERE id = {$userid}";
      ...
      if(isset($_POST['update'])){
        ...
        $query = "UPDATE `10.8.9 disability access scheme` SET total_number_of_access_schemes_for_PWDs = '{$total_number_of_access_schemes_for_PWDs}',title_of_the_access_scheme = '{$title_of_the_access_scheme}', short_description = '{$short_description}', total_cost = '{$total_cost}', fund_source = '{$fund_source}' WHERE id = $userid";
    ...
    <div>
      <form action = "" method = "post">
        <div>
          <label for="user">Total number of access schemes for PWDs: </label>
          <input class = 'type' type="text" name = "total_number_of_access_schemes_for_PWDs" value = "<?php echo $total_number_of_access_schemes_for_PWDs ?>">
        </div>
        <div>
          <label for="user">Title of the access scheme: </label>
          <input class = 'type' type="text" name = "title_of_the_access_scheme" value = "<?php echo $title_of_the_access_scheme ?>">
        </div>
        <div>
    ...
    <div>
      <button class = "back-button" onclick = "window.location.href= '10.8.6read.php';">&laquo; Back</button>
    </div>
