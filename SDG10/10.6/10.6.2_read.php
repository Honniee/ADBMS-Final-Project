  ...
  <div class="container">
    ...
    <table>
      <thead>
        <tr>
          <th>ID</th>
          <th>total_number_of_employees_who_belongs_to_religious_groups_female</th>
      ...
      <tbody>
        <?php
        $query = "SELECT * FROM `10.6.2 Proportion of employees based on religion`";             // SQL query to fetch all table data
        ...
        while ($row = mysqli_fetch_assoc($view_records)) {
          $id = $row['id'];
          $total_number_of_employees_who_belongs_to_religious_groups_female = $row['total_number_of_employees_who_belongs_to_religious_groups_female'];
          $total_number_of_employees_who_belongs_to_religious_groups_male = $row['total_number_of_employees_who_belongs_to_religious_groups_male'];
          ...
          $total_num_employee_population_not_affiliated_with_any_religious = $row['total_num_employee_population_not_affiliated_with_any_religious'];

          echo "<tr>";
          echo "<td>{$id}</td>";
          echo "<td>{$total_number_of_employees_who_belongs_to_religious_groups_female}</td>";
          echo "<td>{$total_number_of_employees_who_belongs_to_religious_groups_male}</td>";
          ...
          echo "<td>{$total_num_employee_population_not_affiliated_with_any_religious}</td>";

          echo "<td><a href='10.6.2_update.php?id={$id}' class='btn btn-edit'>Edit</a></td>";
          echo "<td><a href='10.6.2_delete.php?delete={$id}' class='btn btn-delete'>Delete</a></td>";
          echo "</tr>";
        }
        ?>
      </tbody>
