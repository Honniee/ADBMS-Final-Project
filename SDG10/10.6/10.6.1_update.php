...
<body>
  ...
  <div class="container">
        <a href="10.6.1.php" class="back-button">Back</a>
    </div>
...
<div class="form-container">
        <form action="" method="POST">
            ...
            <label for="total_numbers">Total number of students who belongs to religious groups:
                    <input type="number" name="total_numbers" id="total_numbers" value="<?php echo isset($current_data['Total_number_of_students_who_belongs_to_religious_groups']) ? $current_data['Total_number_of_students_who_belongs_to_religious_groups'] : ''; ?>">
                    (Male: <input type="number" name="male_students" id="male_students" value="<?php echo isset($current_data[' total_number_of_students_who_belongs_to_religious_groups_female']) ? $current_data[' total_number_of_students_who_belongs_to_religious_groups_female'] : ''; ?>"> 
                    / Female: <input type="number" name="female_students" id="female_students" value="<?php echo isset($current_data['total_number_of_students_with_disabilities_female']) ? $current_data['total_number_of_students_with_disabilities_female'] : ''; ?>">
                    )
                </label>
            ...
            <li>
                        <div class="form-group">
                            <label for="total_number_of_students_not_affiliated">Student population who are not affiliated with any religious denomination: 
                                <input type="number" name="total_number_of_students_not_affiliated" id="total_number_of_students_not_affiliated" value="<?php echo isset($current_data['total_number_of_students_not_affiliated']) ? $current_data['total_number_of_students_not_affiliated'] : ''; ?>">
                                (<input type="number" name="total_percentage_of_students_not_affiliated" id="total_percentage_of_students_not_affiliated" value="<?php echo isset($current_data['total_percentage_of_students_not_affiliated']) ? $current_data['total_percentage_of_students_not_affiliated'] : ''; ?>"> 
                                %)
