...
<body>
  <div class=header-SDG10>
    10.6.1 Proportion of employees based on religion</div>
  <div class="sidebar">
  ...
  <div class="container">
        <a href="10.6.2_update.php" class="update-button">Update Records</a>
    </div>
  ...
  <?php
    ...
    <div class="form-container">
        <div class="form-group">
            <label>Total number of employees who belong to religious groups:
                <span style="text-decoration: underline; font-weight: bold;">
                    <?php echo isset($current_data['Total_number_of_employees_who_belongs_to_religious_groups']) ? $current_data['Total_number_of_employees_who_belongs_to_religious_groups'] : 'N/A'; ?>
                </span>
                (Male:
                <span style="text-decoration: underline; font-weight: bold;">
                    <?php echo isset($current_data['total_number_of_employees_who_belongs_to_religious_groups_male']) ? $current_data['total_number_of_employees_who_belongs_to_religious_groups_male'] : 'N/A'; ?>
                </span>
                / Female:
                <span style="text-decoration: underline; font-weight: bold;">
                    <?php echo isset($current_data['total_number_of_employees_who_belongs_to_religious_groups_female']) ? $current_data['total_number_of_employees_who_belongs_to_religious_groups_female'] : 'N/A'; ?>
                </span>
                )
            </label>
        </div>
        ...
        <div class="form-group">
            <label>Meanwhile a total number of
                <span style="text-decoration: underline; font-weight: bold;">
                    <?php echo isset($current_data['total_number_of_employees_not_affiliated']) ? $current_data['total_number_of_employees_not_affiliated'] : 'N/A'; ?>
                </span> or
                <span style="text-decoration: underline; font-weight: bold;">
                    <?php echo isset($current_data['total_percentage_of_employees_not_affiliated']) ? $current_data['total_percentage_of_employees_not_affiliated'] . '%' : 'N/A'; ?>
