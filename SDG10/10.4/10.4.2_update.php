...
<body>
  ...
  10.4.2 Proportion of employees who belong to Indigenous Peoples (IPs)
  </div>
  <div class="sidebar">
  ...
  <div class="container">
  <a href="10.4.2.php" class="back-button">Back</a>
</div>
...
if (isset($_POST['create'])) {
    ...
    $query = "INSERT INTO `10.4.2 proportion of employees who belong to IPs` 
    (total_number_of_IP_employees, 
    total_number_of_IP_employees_male, 
    total_number_of_IP_employees_female, 
    total_employee_population_belong_to_IPs ) 
    VALUES (
    '$total_numbers', 
    '$male_employees', 
    '$female_employees', 
...
$query_fetch = "SELECT * FROM `10.4.2 proportion of employees who belong to IPs` ORDER BY id DESC LIMIT 1";
...
<div class="form-container">
    <div class = "form-group">
        This is the total population of IP employees 
    </div>
    
    <form action="" method="POST">
        <div class="form-group">
            <label for="total_numbers">Total number of IP employees:
                <input type="number" name="total_numbers" id="total_numbers" value="<?php echo isset($current_data['total_number_of_IP_employees']) ? $current_data['total_number_of_IP_employees'] : ''; ?>">
                (Male: <input type="number" name="male_employees" id="male_employees" value="<?php echo isset($current_data['total_number_of_IP_employees_male']) ? $current_data['total_number_of_IP_employees_male'] : ''; ?>"> 
                / Female: <input type="number" name="female_employees" id="female_employees" value="<?php echo isset($current_data['total_number_of_IP_employees_female']) ? $current_data['total_number_of_IP_employees_female'] : ''; ?>">
            </label>
        </div>

        <div class="form-group">
            <input type="number" name="IPs_prevalence" id="IPs_prevalence" value="<?php echo isset($current_data['total_employee_population_belong_to_IPs']) ? $current_data['total_employee_population_belong_to_IPs'] : ''; ?>"> % of the total employee population belong to IPs.
        </div>
