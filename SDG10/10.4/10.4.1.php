...
<body>
    ...
    <div class="container">
        <a href="10.4.1_update.php" class="update-button">Update Records</a>
    </div>
    ...
    <div class="form-container">
        ...
        <div class="form-group">
            <label>Total number of IP students:
                <span style="text-decoration: underline; font-weight: bold;">
                    <?php echo isset($current_data['total_number_of_IP_students']) ? $current_data['total_number_of_IP_students'] : 'N/A'; ?>
                </span>
                (Male:
                <span style="text-decoration: underline; font-weight: bold;">
                    <?php echo isset($current_data['total_number_of_IP_students_male']) ? $current_data['total_number_of_IP_students_male'] : 'N/A'; ?>
                </span>
                / Female:
                <span style="text-decoration: underline; font-weight: bold;">
                    <?php echo isset($current_data['total_number_of_IP_students_female']) ? $current_data['total_number_of_IP_students_female'] : 'N/A'; ?>
                </span>
                )
            </label>
        </div>
        ...
        <div class="form-group">
            <label>
                <span style="text-decoration: underline; font-weight: bold;">
                    <?php echo isset($current_data['total_student_population_belong_to_IPs']) ? $current_data['total_student_population_belong_to_IPs'] : 'N/A'; ?>
                </span>% of the total student population belong to IPs.
            </label>
        </div>
