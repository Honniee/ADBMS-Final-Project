...
<body>
    ...
    <div class="container">
        <a href="10.4.2_update.php" class="update-button">Update Records</a>
    </div>
    ...
    <div class="form-container">
        ...
        <div class="form-group">
            <label>Total number of IP employees:
                <span style="text-decoration: underline; font-weight: bold;">
                    <?php echo isset($current_data['total_number_of_IP_employees']) ? $current_data['total_number_of_IP_employees'] : 'N/A'; ?>
                </span>
                (Male:
                <span style="text-decoration: underline; font-weight: bold;">
                    <?php echo isset($current_data['total_number_of_IP_employees_male']) ? $current_data['total_number_of_IP_employees_male'] : 'N/A'; ?>
                </span>
                / Female:
                <span style="text-decoration: underline; font-weight: bold;">
                    <?php echo isset($current_data['total_number_of_IP_employees_female']) ? $current_data['total_number_of_IP_employees_female'] : 'N/A'; ?>
                </span>
                )
            </label>
        </div>
        ...
        <div class="form-group">
            <label>
                <span style="text-decoration: underline; font-weight: bold;">
                    <?php echo isset($current_data['total_employee_population_belong_to_IPs']) ? $current_data['total_employee_population_belong_to_IPs'] : 'N/A'; ?>
                </span>% of the total employee population belong to IPs.
            </label>
        </div>
