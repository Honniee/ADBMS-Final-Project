...
<body>
  ...
  <div class="container">
        <a href="10.7.2_update.php" class="update-button">Update Records</a>
    </div>
...
if (isset($_POST['create'])) {
    ...
    $employee_refugee_percentage = $_POST['student_employee_percentage'];

    // SQL query to insert data into table
    $query = "INSERT INTO `10.7.2 Proportion of refugee employees` 
        (`total_refugee_employee_male`, `total_refugee_employee_female`, `employee_refugee_percentage`)  
        VALUES ('$total_refugee_employee_male', '$total_refugee_employee_female', '$employee_refugee_percentage')";
...
$query_fetch = "SELECT * FROM `10.7.2 Proportion of refugee employees` ORDER BY id DESC LIMIT 1";
...
<div class="form-container">
    <div class="form-group">
        <label>Total number of refugee employees:
            <span style="text-decoration: underline; font-weight: bold;">
                <?php echo isset($current_data['total_refugee_employee_male']) && isset($current_data['total_refugee_employee_female']) ? $current_data['total_refugee_employee_male'] + $current_data['total_refugee_employee_female'] : 'N/A'; ?>
            </span> 
            (Male:
            <span style="text-decoration: underline; font-weight: bold;">
                <?php echo isset($current_data['total_refugee_employee_male']) ? $current_data['total_refugee_employee_male'] : 'N/A'; ?>
            </span> / Female:
            <span style="text-decoration: underline; font-weight: bold;">
                <?php echo isset($current_data['total_refugee_employee_female']) ? $current_data['total_refugee_employee_female'] : 'N/A'; ?>
            </span>)
        </label>
    </div>
</div>
